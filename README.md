...
Переменные окружения: `DB_HOST`, `DB_PORT`, `DB_USER`, `DB_PASS`, `DB_NAME`, `REDIS_ADDR`, `REDIS_PASSWORD`, `REDIS_DB`, `REDIS_CHANNEL`, `PORT`, `JWT_SECRET`, `RUN_MIGRATIONS`, `MIGRATIONS_PATH`.
